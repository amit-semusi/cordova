...
AppICE.prototype.startContext = function(gcmID, success, error) {
  ...
  [{"old":"", "new":"", "loc":location.hash, "h":document.documentElement.clientHeight, 
...
//   console.log("AppICE.js old/initsdk")
//   cordova.exec(success, error, "AppICEPlugin", "initSdk",
//    [{"appID":appID, "appKey":appKey, "apiKey":apiKey, "gcmID":gcmID}]);
...
AppICE.prototype.initSdk = function(appID, appKey, apiKey, gcmID,region,baseURL , success, error) {

console.log("Appice initSdk latest success")
  cordova.exec(success, error, "AppICEPlugin", "initSdk",
   [{"appID":appID, "appKey":appKey, "apiKey":apiKey, "gcmID":gcmID,
   "region":region,"baseURL":baseURL}]);
...
AppICE.prototype.trackScreens = function(e, success, error) {
    ...
    cordova.exec(success, error, "AppICEPlugin", "trackScreens",
     [{"old":e.oldURL, "new":e.newURL, "loc":location.hash,

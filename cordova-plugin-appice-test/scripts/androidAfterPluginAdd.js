...
module.exports = function(context) {
	...
	var pluginsAppiceRoot = path.join(context.opts.projectRoot, 'plugins/cordova-plugin-appice-test');
	...
	var platformwww1 = path.join(platformRoot, '/platform_www/plugins/cordova-plugin-appice-test/www/AppICE.js');
